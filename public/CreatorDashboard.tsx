...
import { getMissionEnrollmentCount } from '../services/missionProgressService';
...
const CreatorDashboard: React.FC = () => {
  ...
  const loadData = React.useCallback(async () => {
    ...
    setState(s => ({ ...s, missions: missionsData, currentUserId: user ? user.id : s.currentUserId, loading: false }));
  }, []);
                    ...
                    >
                      ...
                      <div className="p-5 flex-1 flex flex-col">
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-auto">
                          ...
                          <Link
                            to={`/mission/${m.id}`}
                            className="bg-primary/10 text-primary py-2 rounded-lg font-bold text-xs flex items-center justify-center hover:bg-primary/20 transition-colors"
                          >
