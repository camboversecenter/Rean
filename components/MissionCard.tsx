  ...
  if (compact) {
    return (
      <Link
        ...
        className="group block bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all hover:border-primary/30"
      >
        ...
        <div className="p-5 flex flex-col flex-grow relative">
          ...
          <div className="flex items-center justify-between text-xs text-gray-500 mb-4">
            ...
            <div className="flex items-center gap-3">
              <span className="flex items-center" title="Squad Size">
                <Users2 className="h-3.5 w-3.5 mr-1 text-gray-400" /> {mission.squadSize}
              </span>
              {mission.enrolledCount !== undefined && (
                <span
                  className="flex items-center text-blue-600 font-medium"
          ...
          <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span
                className={`text-sm font-bold ${mission.price === 0 ? 'text-green-600' : 'text-gray-900'}`}
              >
                {mission.price === 0 ? 'Free' : formatRiel(mission.price)}
              </span>
