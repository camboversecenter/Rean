...
import { 
    MessageCircle, User, Phone, CheckCircle, Clock, Loader2 
} from './Icons';
        ...
        <div className="space-y-4 animate-fade-in">
            ...
            {inquiries.length === 0 ? (
                ...
                <div className="grid gap-4">
                    {inquiries.map(item => (
                        <div key={item.id} className="bg-white p-5 rounded-3xl border border-gray-100 shadow-sm flex flex-col md:flex-row justify-between gap-4 hover:shadow-md transition-shadow">
                                ...
                                <div className="min-w-0">
                                    ...
                                    {item.admissionTitle && (
                                        <div className="mt-3 flex items-center">
                                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">ចំណាប់អារម្មណ៍លើ៖</span>
