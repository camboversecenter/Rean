...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const checkError = () => {
      ...
      // Fallback for messy URL hash parsing
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12 font-sans">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-6 md:p-10 text-center border border-gray-100">
        ...
        <p className="text-gray-500 mb-8 leading-relaxed">
          វេទិកាអប់រំសម្រាប់អ្នកសិក្សាជំនាន់ថ្មី។<br/>
          ចូលប្រើប្រាស់ដើម្បីចាប់ផ្តើម។
        </p>

        {errorMessage && (
          <div className="mb-6 bg-red-50 border border-red-100 text-red-600 px-4 py-4 rounded-2xl flex items-center text-left animate-pulse-once">
        ...
        <div className="mt-8 flex flex-col items-center space-y-4">
            <div className="flex flex-wrap justify-center gap-2">
                ...
                >
                    <Send className="h-3 w-3 mr-1.5 rotate-45 transform -translate-y-[1px]" />
                    តេឡេក្រាមសហគមន៍ (Telegram)
                </a>
                <Link to="/license" className="inline-flex items-center justify-center px-4 py-2 bg-gray-50 rounded-full text-[10px] text-primary font-bold hover:bg-primary/5 transition-colors border border-gray-100">
