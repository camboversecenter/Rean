        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full">
            ...
            <div className="p-4 space-y-2 flex-1 overflow-y-auto max-h-[400px]">
                {classes.length === 0 ? (
                    ...
                    classes.map(c => (
                        <div key={c.id} className={`group flex items-center justify-between p-1 rounded-xl transition-all ${selectedClassId === c.id ? 'bg-primary/5 ring-1 ring-primary/20' : 'hover:bg-gray-50'}`}>
                            <button 
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50">
                <label className="text-[10px] font-bold text-gray-500 uppercase mb-2 block">បង្កើតថ្នាក់ថ្មី</label>
