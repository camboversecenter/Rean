...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-surface border-t border-line-strong mt-8 mb-16 md:mb-0">
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-1">
            <p className="font-bold text-content">REAN</p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-content-muted hover:text-primary transition-colors"
        ...
        <div className="mt-6 pt-4 border-t border-line flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs text-content-faint">
          {/*
