            ...
            <div className="flex items-center justify-between px-4 py-2 bg-[#21252b] border-b border-gray-700">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {language !== 'html' && (
                        ...
                        >
                            {(isRunning || isPyodideLoading) ? <Loader2 className="h-3 w-3 animate-spin"/> : <PlayCircle className="h-3 w-3" />}
            ...
            {language !== 'html' && (
                <div className="h-1/3 min-h-[150px] border-t border-gray-700 bg-[#1e2127] flex flex-col">
                    ...
                    <div className="flex-1 p-4 overflow-y-auto font-mono text-xs text-gray-300 space-y-1">
                        {output.length === 0 ? (
                            <span className="text-gray-600 italic">No output yet. Run the code to see results.</span>
                        ) : (
                            output.map((line, idx) => (
                                <div key={idx} className="break-words whitespace-pre-wrap border-b border-white/5 pb-0.5 mb-0.5">
