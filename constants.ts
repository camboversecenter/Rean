...
export const MOCK_MISSIONS: Mission[] = [
  {
    ...
    description:
      'You and your squad will act as a marketing agency launching a new coffee brand in Phnom Penh. Analyze competitors and create a social media plan.',
    modules: [
      {
        id: 'mod1',
        ...
        aiPersona:
          'You are a Senior Marketing Director at a top agency in Phnom Penh. The user is a Junior Marketer. Critique their SWOT analysis. Ask them specifically about their "Weakness" section. Do not give them the answers, guide them to find it.',
        initialPrompt:
          'Welcome to the agency. Your first task is to understand the battlefield. Tell me which 3 coffee shops you are analyzing?',
      },
      {
        id: 'mod2',
        ...
        aiPersona:
          'You are a Consumer Psychology Expert. Help the student dig deep into "Why" people buy. Challenge their assumptions.',
        initialPrompt:
          'Good work on the SWOT. Now, who are we selling to? Describe your ideal customer.',
      },
      {
        id: 'mod3',
        ...
        aiPersona:
          'You are a Social Media Manager. Critique the tone, emoji usage, and call-to-action (CTA).',
  ...
  },
  {
    ...
    description:
      'Master the physics of projectile motion using the PhET Interactive Simulation. You will conduct experiments to understand how angle and initial speed affect distance.',
    modules: [
      {
        id: 'sim1',
        ...
        aiPersona:
          'You are a Physics Lab Instructor. Verify the student has hit the target based on their screenshot. Ask them what happens to the range if they increase the angle above 45 degrees.',
        initialPrompt:
          'Welcome to the lab! Open the simulation tab. Try to hit the target at 20m. What settings worked for you?',
        simulationConfig: {
          type: 'phet',
      ...
      },
      {
        ...
        aiPersona:
          'You are a Physics Professor. Explain why 45 degrees usually gives max range (ignoring air resistance).',
        initialPrompt:
          'Now, lets optimize. Set speed to 15 m/s. Which angle makes the cannonball go furthest?',
        simulationConfig: {
          type: 'phet',
          url: 'https://phet.colorado.edu/sims/html/projectile-motion/latest/projectile-motion_en.html',
        },
  ...
  },
  {
    ...
    description:
      'Stop watching videos. Build your own portfolio website using React. Your squad will code review each other.',
    modules: [
      {
        id: 'mod1',
        ...
        aiPersona:
          'You are a Senior React Developer. Focus on "Component Reusability". If the student suggests making one giant component, correct them gently.',
        initialPrompt:
          'Alright dev, before we write code, we plan. What sections will your portfolio have?',
      },
      {
        id: 'mod2',
      ...
      },
      {
        ...
        aiPersona:
          'You are a QA Engineer. I will try to break your form. Did you handle empty fields?',
  ...
  },
  {
    ...
    description:
      'Research a province in Cambodia and propose a sustainable eco-tourism business plan.',
    modules: [
      {
        id: 'mod1',
        ...
        aiPersona:
          'You are a Venture Capitalist. You only care about "Scalability" and "Impact". Be skeptical about their problem statement.',
...
export const MOCK_SCHOOLS: School[] = [
  {
    ...
    description:
      'សាកលវិទ្យាល័យឈានមុខគេផ្នែកបច្ចេកវិទ្យា និងវិស្វកម្មនៅកម្ពុជា។ យើងផ្តោតលើការអនុវត្តជាក់ស្តែង និងការបង្កើតថ្មី។',
    majors: [
      'Computer Science',
      'Data Science',
      'Civil Engineering',
    ...
    admissions: [
      {
        ...
        description:
          'កំពុងទទួលពាក្យចូលរៀនថ្នាក់បរិញ្ញាបត្រឆ្នាំសិក្សាថ្មី។ មានអាហារូបករណ៍រហូតដល់ ១០០%។',
        majors: [
          'Computer Science',
          'Data Science',
          'Civil Engineering',
...
export const MOCK_TUTOR_REQUESTS: TutorRequest[] = [
  {
    ...
    description:
      'Need a female tutor for my daughter. Focus on reading and writing. Weekend mornings preferred.',
    ...
    replies: [
      {
        ...
        isAI: true,
        content:
          'Imagine a coin spinning on a table. It is neither Heads nor Tails until it stops. Normal computers are Heads OR Tails (0 or 1). Quantum computers are the spinning coin—they can be both at once, letting them solve mazes instantly.',
        timestamp: 'Just now',
    ...
    replies: [
      {
        ...
        isAI: true,
        content:
          'ភាពមិនប្រែប្រួល គឺជាគន្លឹះនៃភាពស្ទាត់ជំនាញ (Pheap min prae proul keu jea kunleuh nei pheap sdat jumnanh).',
        timestamp: '5 hours ago',
        reactions: { heart: 0, bulb: 0, thumb: 0 },
        recommendedLinks: [],
      },
