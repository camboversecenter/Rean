        ...
        <div className="bg-surface rounded-3xl shadow-sm border border-line overflow-hidden mb-8">
          <div className="bg-blue-600 p-8 text-white">
            ...
            <p className="text-blue-100 max-w-2xl leading-relaxed">
              ប្រព័ន្ធផ្សារភ្ជាប់សិស្សទៅកាន់គ្រឹះស្ថានសិក្សា។ ស្វែងយល់ពីរបៀបស្វែងរកសាលា អាហារូបករណ៍
              និងរបៀបដែលសាលាអាចគ្រប់គ្រងការជ្រើសរើសសិស្ស។
            </p>
          </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="bg-surface-2 p-5 rounded-2xl border border-line">
                  <h3 className="font-bold text-content mb-2 flex items-center">
                    <Search className="h-4 w-4 mr-2 text-primary" /> ស្វែងរកសាលា
                  </h3>
                  <p className="text-sm text-content-muted mb-4">
                    ចូលទៅកាន់ទំព័រ <strong>"សាលារៀន"</strong> ដើម្បីស្វែងរកសាកលវិទ្យាល័យ ឬវិទ្យាល័យ។
                    អ្នកអាចប្រើប្រាស់តម្រង (Filter) ដើម្បីស្វែងរកតាមប្រភេទ (University, Vocational)។
                  </p>
                  <div className="bg-surface p-3 rounded-xl border border-line-strong text-xs text-content-muted">
                    Tip: វាយឈ្មោះជំនាញ (ឧ. IT, Architecture) ក្នុងប្រអប់ស្វែងរក
                    ដើម្បីរកសាលាដែលមានជំនាញនោះ។
                  </div>
                </div>

                <div className="bg-surface-2 p-5 rounded-2xl border border-line">
                  <h3 className="font-bold text-content mb-2 flex items-center">
                    <Award className="h-4 w-4 mr-2 text-yellow-500" /> អាហារូបករណ៍
                  </h3>
                  <p className="text-sm text-content-muted mb-4">
                    សាលានីមួយៗនឹងបង្ហាញ "Admission Campaign" ដែលកំពុងបើក។ ប្រសិនបើមាននិមិត្តសញ្ញា{' '}
                    <span className="inline-block bg-yellow-100 text-yellow-800 text-[10px] px-1 rounded font-bold">
                      Scholarship
                    </span>{' '}
                    មានន័យថាសាលានោះកំពុងផ្តល់អាហារូបករណ៍។
                  </p>
                </div>

                <div className="bg-surface-2 p-5 rounded-2xl border border-line md:col-span-2">
                  <h3 className="font-bold text-content mb-2 flex items-center">
                    <MessageCircle className="h-4 w-4 mr-2 text-green-500" /> ការសាកសួរព័ត៌មាន
                    (Inquiry)
                  </h3>
                  <p className="text-sm text-content-muted mb-2">
                    នៅពេលចូលមើលព័ត៌មានលម្អិតរបស់សាលា អ្នកអាចចុចប៊ូតុង{' '}
                    <strong>"ទាក់ទង (Contact)"</strong> ឬ{' '}
                    <strong>"ចាប់អារម្មណ៍ (Interested)"</strong>។
                  </p>
                  <ol className="list-decimal list-inside text-sm text-content-muted space-y-1 ml-2">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">បង្កើតការជ្រើសរើស (Create Admission)</h3>
                    <div className="text-sm text-content-muted mt-1">
                      ជំនួសឱ្យការបង្ហោះរូបភាព Poster តែមួយមុខ សាលាអាចបង្កើត "Admission Digital"
                      ដែលមានព័ត៌មានច្បាស់លាស់អំពី៖
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">គ្រប់គ្រងសំណួរ (Leads Management)</h3>
                    <p className="text-sm text-content-muted mt-1">
                      រាល់ពេលសិស្សចុច "Contact" ទិន្នន័យនឹងធ្លាក់ចូលក្នុងតារាង{' '}
                      <strong>"Inquiries"</strong> ក្នុង Dashboard។ អ្នកអាចមើលឃើញលេខទូរស័ព្ទ
                      និងសាររបស់សិស្ស ហើយចុចសម្គាល់ថា{' '}
                      <span className="font-bold text-green-600">Contacted</span>{' '}
                      ពេលបានទាក់ទងរួចរាល់។
                    </p>
                  </div>
                </div>
