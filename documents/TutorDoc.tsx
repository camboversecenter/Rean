            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">បង្កើតប្រវត្តិរូប (Create Profile)</h3>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">គ្រប់គ្រងការកក់ (Manage Bookings)</h3>
                    <p className="text-sm text-content-muted mt-1">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">ថ្នាក់រៀនឌីជីថល (Classroom Log)</h3>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">ស្វែងរកការងារ (Job Market)</h3>
                    <p className="text-sm text-content-muted mt-1">
