...
import { 
    Zap, MessageCircle, Gift, ShieldCheck, 
    ChevronLeft, Brain, Ghost, CheckCircle, Award
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden mb-8">
                    <div className="bg-yellow-500 p-8 text-white">
                        ...
                        <p className="text-yellow-50 max-w-2xl leading-relaxed">
                            រៀនផ្លូវកាត់ដោយការសួរនិងឆ្លើយ។ ប្រើប្រាស់ AI ដើម្បីទទួលបានចម្លើយភ្លាមៗ ឬដាក់ប្រាក់រង្វាន់ (Bounty) ដើម្បីទទួលបានចម្លើយពីអ្នកជំនាញ។
                        </p>
                    </div>
                    ...
                    <div className="p-8">
                        ...
                        <div className="mb-12">
                            <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                                <span className="bg-yellow-100 text-yellow-600 w-8 h-8 rounded-full flex items-center justify-center mr-3 text-sm">1</span>
                                សម្រាប់អ្នកសួរ (Asking Questions)
                            </h2>
                            
                            <div className="grid gap-6 md:grid-cols-2">
                                <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                                    <h3 className="font-bold text-gray-800 mb-2 flex items-center"><Brain className="h-4 w-4 mr-2 text-primary"/> ចម្លើយរហ័ស (Flash Answer)</h3>
                                    <p className="text-sm text-gray-600 mb-4">
                                        មិនបាច់រង់ចាំយូរ! រាល់សំណួរដែលអ្នកសួរ <strong>សុភាទន្សាយ (AI)</strong> នឹងឆ្លើយតបភ្លាមៗក្នុងរយៈពេលប៉ុន្មានវិនាទី ដើម្បីផ្តល់គំនិតបឋម។
                                    </p>
                                </div>

                                <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                                    <h3 className="font-bold text-gray-800 mb-2 flex items-center"><Gift className="h-4 w-4 mr-2 text-pink-500"/> ប្រាក់រង្វាន់ (Bounty System)</h3>
                                    <p className="text-sm text-gray-600 mb-4">
                                        ត្រូវការចម្លើយលម្អិតពីមនុស្ស? អ្នកអាចដាក់ "ប្រាក់រង្វាន់" (១០-១០០ ពិន្ទុ)។ សំណួរដែលមានរង្វាន់នឹងទាក់ទាញអ្នកជំនាញមកឆ្លើយបានលឿនជាង។
                                    </p>
                                </div>

                                <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100 md:col-span-2">
                                    <h3 className="font-bold text-gray-800 mb-2 flex items-center"><Ghost className="h-4 w-4 mr-2 text-gray-500"/> មុខងារអនាមិក (Anonymous Mode)</h3>
                        ...
                        <div>
                            ...
                            <div className="bg-red-50 border border-red-100 rounded-xl p-4 mb-6 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-red-700 leading-relaxed mt-1">
                                        ដើម្បីការពារការឆ្លើយយកតែលុយ (Spam/Farming) ប្រព័ន្ធប្រើ AI ដើម្បីដាក់ពិន្ទុលើចម្លើយរបស់អ្នក។
                                        <br/>
                                        <strong>លក្ខខណ្ឌទទួលបានពិន្ទុ៖</strong> ចម្លើយត្រូវមានពិន្ទុគុណភាព <strong>≥ 70</strong>។ ចម្លើយខ្លីៗដូចជា "Good", "Thanks" នឹងមិនទទួលបានពិន្ទុទេ។
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex gap-4 items-start">
                                    <div className="p-2 bg-yellow-50 rounded-lg text-yellow-600 mt-1"><Award className="h-5 w-5"/></div>
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">
                                            ...
                                            <ul className="list-disc list-inside mt-1 ml-2 text-gray-500">
                                                <li>ទទួលបាន <strong>+2 XP</strong> និង <strong>+1 Point</strong> ភ្លាមៗ។</li>
                                ...
                                <div className="flex gap-4 items-start">
                                    <div className="p-2 bg-green-50 rounded-lg text-green-600 mt-1"><CheckCircle className="h-5 w-5"/></div>
                                    <div>
