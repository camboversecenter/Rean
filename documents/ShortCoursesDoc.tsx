              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="bg-surface-2 p-5 rounded-2xl border border-line">
                  ...
                  <div className="flex gap-2 text-xs">
                    <span className="bg-surface px-2 py-1 rounded border flex items-center">
                ...
                <div className="bg-surface-2 p-5 rounded-2xl border border-line">
                  ...
                  <p className="text-sm text-content-muted mb-4">
                    ...
                    <span className="inline-block bg-surface border px-1 rounded mx-1 text-xs">
                      +
                    </span>{' '}
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">បង្កើតវគ្គសិក្សា (Add Course)</h3>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">AI Syllabus Architect</h3>
                    <p className="text-sm text-content-muted mt-1">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-content">គ្រប់គ្រងការចុះឈ្មោះ (Enrollments)</h3>
                    <p className="text-sm text-content-muted mt-1">
